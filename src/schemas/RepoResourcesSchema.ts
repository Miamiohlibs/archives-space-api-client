...
export const resolvableRefSchema = <T extends z.ZodTypeAny>(
  resolvedSchema: T,
) =>
  z.object({
    ref: z.string(),
...
export const containerLocationSchema = resolvableRefSchema(
  locationResolvedSchema,
).extend({
  status: z.string(),
  start_date: z.string(),
  jsonmodel_type: z.string(),
...
export const topContainerSchema = resolvableRefSchema(
  topContainerResolvedSchema,
);
